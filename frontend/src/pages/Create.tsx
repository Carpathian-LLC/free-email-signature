...
function loadStyle(): StyleOptions {
  try {
    ...
    return {
      ...
      addressTwoLines: parsed.addressTwoLines === true,
    };
            ...
            <div className="space-y-4">
              ...
              <Section title="Contact">
                ...
                <label className="flex items-center gap-2 text-xs text-gray-700 cursor-pointer select-none">
                  <input
                    type="checkbox"
                    checked={styleOptions.addressTwoLines}
                    onChange={e => setStyleOptions(prev => ({ ...prev, addressTwoLines: e.target.checked }))}
                    className="accent-brand-blue w-3.5 h-3.5"
                  />
                  Show address on two lines
                </label>
              </Section>

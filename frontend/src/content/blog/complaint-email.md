---
title: "How to Write a Complaint Email That Gets Results"
...
1. **A subject line that states the issue and the account.** Make it searchable and specific.
2. **One sentence naming the problem.** Lead with it. Do not warm up.
3. **The relevant facts.** Dates, order numbers, amounts, what you expected versus what happened.
4. **Evidence.** Attachments, screenshots, or quoted confirmation text.
5. **A clear, specific request.** Tell them exactly what resolution you want.
6. **A reasonable deadline and a polite close.**
...
- **Use a real, professional sign-off** with your name and the contact details tied to the account. A clean, consistent email signature makes follow-up effortless and looks more credible than a bare name. If you do not have one set up, our guide on [email signature best practices](/email-signature-best-practices) covers what to include.
